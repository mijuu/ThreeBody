...
import net.jejer.threebody.async.LoginEvent;
import net.jejer.threebody.async.LoginHelper;
import net.jejer.threebody.async.NetworkReadyEvent;
import net.jejer.threebody.async.TaskHelper;
import net.jejer.threebody.async.UpdateHelper;
...
import net.jejer.threebody.ui.widget.LoginDialog;
...
import net.jejer.threebody.utils.DrawerHelper;
import net.jejer.threebody.utils.HiParserThreadList;
...
public class MainFrameActivity extends BaseActivity {
    ...
    private void setIcon(int icon) {
        ...
        pm.setComponentEnabledSetting(
                new ComponentName(this, "net.jejer.threebody.ng.MainActivity-Original"),
        ...
        pm.setComponentEnabledSetting(
                new ComponentName(this, "net.jejer.threebody.ng.MainActivity-Circle"),
