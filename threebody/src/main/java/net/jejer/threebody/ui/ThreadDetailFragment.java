...
import net.jejer.threebody.BuildConfig;
import net.jejer.threebody.R;
import net.jejer.threebody.async.FavoriteHelper;
import net.jejer.threebody.async.NetworkReadyEvent;
import net.jejer.threebody.async.PostHelper;
import net.jejer.threebody.bean.DetailBean;
...
import net.jejer.threebody.cache.ThreadDetailCache;
import net.jejer.threebody.db.ContentDao;
import net.jejer.threebody.db.HistoryDao;
import net.jejer.threebody.glide.GlideImageView;
import net.jejer.threebody.job.EventCallback;
import net.jejer.threebody.job.JobMgr;
import net.jejer.threebody.job.PostEvent;
import net.jejer.threebody.job.PostJob;
import net.jejer.threebody.job.ThreadDetailEvent;
import net.jejer.threebody.job.ThreadDetailJob;
import net.jejer.threebody.okhttp.OkHttpHelper;
import net.jejer.threebody.ui.adapter.RecyclerItemClickListener;
import net.jejer.threebody.ui.adapter.ThreadDetailAdapter;
import net.jejer.threebody.ui.widget.BottomDialog;
import net.jejer.threebody.ui.widget.ContentLoadingView;
import net.jejer.threebody.ui.widget.CountdownButton;
import net.jejer.threebody.ui.widget.HiProgressDialog;
import net.jejer.threebody.ui.widget.OnSingleClickListener;
import net.jejer.threebody.ui.widget.SimpleDivider;
import net.jejer.threebody.ui.widget.SimpleGridMenu;
import net.jejer.threebody.ui.widget.SmoothLinearLayoutManager;
import net.jejer.threebody.ui.widget.ValueChagerView;
import net.jejer.threebody.ui.widget.XFooterView;
import net.jejer.threebody.ui.widget.XHeaderView;
import net.jejer.threebody.ui.widget.XRecyclerView;
import net.jejer.threebody.utils.ColorHelper;
import net.jejer.threebody.utils.Constants;
import net.jejer.threebody.utils.HiUtils;
import net.jejer.threebody.utils.HtmlCompat;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_copy_url:
                ...
                ClipData clip = ClipData.newPlainText("THREAD URL FROM ThreeBody", HiUtils.DetailListUrl + mTid);
    ...
    private void showGridMenu(final DetailBean detailBean) {
        ...
        mGridMenu.add("copy", "复制文字", new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                ClipData clip = ClipData.newPlainText("COPY FROM ThreeBody", detailBean.getContents().getCopyText());
                clipboard.setPrimaryClip(clip);
                UIUtils.toast("文字已复制");
            }
        });
