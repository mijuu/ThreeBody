...
public class HiUtils {
    public static final String UserAgentPrefix = "net.jejer.threebody ";
...
//    public final static int[] DEFAULT_FORUMS = {FID_DISCOVERY, FID_BS, 7, 59};
    ...
    public static void updateBaseUrls() {
        ...
        LoginGetFormHash = BaseUrl + "logging.php?action=login&referer=http%3A//bbs.threebody.com.cn/forum/logging.php";
